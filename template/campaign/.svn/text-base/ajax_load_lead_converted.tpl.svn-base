...
<table width="100%">
	<tr>
		<td><span class="greetUser"><span class="greetUser">Converted Leads</span></td>	
	</tr>
</table>
<table width="100%" cellpadding="3" cellspacing="0" border="0" class="productListing">
	...
	<tr onmouseover="this.className='row2'" onmouseout="this.className='row1'" onDblClick="window.location='{$ROOT_URL}/index.php?page=leads:view_lead&lead_id={$lead->get_lead_id()}';">
		...
		<td class="productListing-data"><a href="{$ROOT_URL}/index.php?page=company:view_company&company_id={$lead->get_company_id()}">{$lead->get_company_id()|company_name}</a></td>
