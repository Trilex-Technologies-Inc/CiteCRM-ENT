...
<table cellpadding="0" cellspacing="0" width="400">
	<tr>
		<td><span class="greetUser">Update Calendar ID# {$calendar->get_calendar_id()}</span></td>
		<td align="right"></td>
</tr>
</table>
...
<form method="post" action="{$ROOT_URL}/index.php?page=calendar:update_calendar" id="add_calendar_frm">

<table cellpadding="5" cellspacing="5" class="formArea" width="400">
	<tr>
		<td class="formAreaTitle">{$translate_field_calendar_year}</td>
		<td class="fieldValue"><input type="text" name="calendar_year" value="{$calendar->get_calendar_year()}" id="calendar_year">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_calendar_month}</td>
		<td class="fieldValue"><input type="text" name="calendar_month" value="{$calendar->get_calendar_month()}" id="calendar_month">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_calendar_day}</td>
		<td class="fieldValue"><input type="text" name="calendar_day" value="{$calendar->get_calendar_day()}" id="calendar_day">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_calendar_hour}</td>
		<td class="fieldValue"><input type="text" name="calendar_hour" value="{$calendar->get_calendar_hour()}" id="calendar_hour">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_calendar_min}</td>
		<td class="fieldValue"><input type="text" name="calendar_min" value="{$calendar->get_calendar_min()}" id="calendar_min">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_calendar_type}</td>
		<td class="fieldValue"><input type="text" name="calendar_type" value="{$calendar->get_calendar_type()}" id="calendar_type">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_user_id}</td>
		<td class="fieldValue"><input type="text" name="user_id" value="{$calendar->get_user_id()}" id="user_id">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_calendar_title}</td>
		<td class="fieldValue"><input type="text" name="calendar_title" value="{$calendar->get_calendar_title()}" id="calendar_title">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_calendar_text}</td>
		<td class="fieldValue"><input type="text" name="calendar_text" value="{$calendar->get_calendar_text()}" id="calendar_text">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_calendar_avtive}</td>
		<td class="fieldValue"><input type="text" name="calendar_avtive" value="{$calendar->get_calendar_avtive()}" id="calendar_avtive">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_calendar_private}</td>
		<td class="fieldValue"><input type="text" name="calendar_private" value="{$calendar->get_calendar_private()}" id="calendar_private">
</td>
	</tr>
	<tr>
		<td colspan="12">
