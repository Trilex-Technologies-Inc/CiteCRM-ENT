...
<table>
	<tr>
		<td><span class="greetUser">Edit Contact Information</span></td>	
	</tr>
</table>
					...
					<td valign="top">				
						...
						<table cellpadding="3" cellspacing="0" border="0">
							<tr><tr>
								...
								<td colspan="2" align="center"><input type="button" value="save" onclick="save_contact()"> <input type="button" name="cancel" value="Cancel" onclick=" load_window('Address','','','')"></td>
							</tr>
						</table>                       
					</td>
					<td width="20"><br></td>
