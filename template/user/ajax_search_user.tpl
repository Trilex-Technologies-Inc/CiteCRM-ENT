...
{foreach from=$userArray item=user}
	...
	{if  $user->getUserTypeID() == '1'}
		onDblClick="window.location='{$ROOT_URL}/index.php?page=user:view_employee&user_id={$user->getUserID()}';">
	{else}
		onDblClick="window.location='{$ROOT_URL}/index.php?page=user:admin_view_user_detail&userID={$user->getUserID()}';">
	{/if}
