...
<table cellpadding="0" cellspacing="0" width="400">
	<tr>
		<td><span class="greetUser">{$translate_text_add_new_record_to} Credit Cards</td>
		<td align="right"></td>
</tr>
</table>
...
<form method="post" action="{$ROOT_URL}/index.php?page=credit_card:add_credit_card" id="add_credit_card_frm">

<table cellpadding="5" cellspacing="5" class="formArea" width="400">
	<tr>
		<td class="formAreaTitle">{$translate_field_credit_card_type}</td>
		<td class="fieldValue"><input type="text" name="credit_card_type" value="{$credit_card_type}" size="" id="credit_card_type">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_credit_card_name}</td>
		<td class="fieldValue"><input type="text" name="credit_card_name" value="{$credit_card_name}" size="" id="credit_card_name">
</td>
	</tr>
	<tr>
