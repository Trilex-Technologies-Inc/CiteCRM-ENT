...
<table width="100%" cellpadding="3" cellspacing="0" border="0" class="productListing">
	...
	{foreach from=$vendor_contactArray item=vendor_contact}
	<tr>
		<td class="productListing-data">{$vendor_contact->get_vendor_contact_id()}</td>
		<td class="productListing-data">{$vendor_contact->get_vendor_id()}</td>
		<td class="productListing-data">{$vendor_contact->get_vendor_contact_type()}</td>
		<td class="productListing-data">{$vendor_contact->get_vendor_contact_value()}</td>
		<td class="productListing-data"><a href="index.php?page=vendor_contact:view_vendor_contact&vendor_contact_id={$vendor_contact->get_vendor_contact_id()}"><img src="images/icons/srch_16.gif" alt="View" border="0"></a></td>
	</tr>
	{foreachelse}
	<tr>
