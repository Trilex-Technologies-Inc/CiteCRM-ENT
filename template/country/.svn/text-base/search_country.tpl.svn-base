...
<table width="100%" cellpadding="3" cellspacing="0" border="0" class="productListing">
	...
	{foreach from=$countryArray item=country}
	<tr>
		<td class="productListing-data">{$country->get_country_id()}</td>
		<td class="productListing-data">{$country->get_country_code()}</td>
		<td class="productListing-data">{$country->get_country_text()}</td>
		<td class="productListing-data"><a href="index.php?page=country:view_country&country_id={$country->get_country_id()}"><img src="images/icons/srch_16.gif" alt="View" border="0"></a></td>
	</tr>
	{foreachelse}
	<tr>
