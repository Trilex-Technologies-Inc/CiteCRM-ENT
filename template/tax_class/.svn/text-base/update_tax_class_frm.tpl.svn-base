<!-- update_tax_class_frm -->
{include file="core/header.tpl"}

<table cellpadding="0" cellspacing="0" width="400">
	<tr>
		<td><span class="greetUser">Update Tax Class ID# {$tax_class->get_tax_class_id()}</span></td>
		<td align="right"></td>
</tr>
</table>
...
<form method="post" action="index.php?page=tax_class:update_tax_class" id="add_tax_class_frm">

<table cellpadding="5" cellspacing="5" class="formArea" width="400">
	<tr>
		<td class="formAreaTitle">{$translate_field_tax_class_title}</td>
		<td class="fieldValue"><input type="text" name="tax_class_title" value="{$tax_class->get_tax_class_title()}" id="tax_class_title">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_tax_class_description}</td>
		<td class="fieldValue"><input type="text" name="tax_class_description" value="{$tax_class->get_tax_class_description()}" id="tax_class_description">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_tax_type}</td>
		<td class="fieldValue"><input type="text" name="tax_type" value="{$tax_class->get_tax_type()}" id="tax_type">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_tax_class_active}</td>
		<td class="fieldValue"><input type="text" name="tax_class_active" value="{$tax_class->get_tax_class_active()}" id="tax_class_active">
</td>
	</tr>
	<tr>
		<td colspan="5">
		<input type="hidden" name="tax_class_id" value="{$tax_class_id}">
