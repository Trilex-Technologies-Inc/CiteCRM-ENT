...
<table cellpadding="0" cellspacing="0" width="400">
	<tr>
		<td><span class="greetUser">Update Tax Rates ID# {$tax_rate->get_tax_rate_id()}</span></td>
		<td align="right"></td>
</tr>
</table>
...
<form method="post" action="index.php?page=tax_rate:update_tax_rate" id="add_tax_rate_frm">

<table cellpadding="5" cellspacing="5" class="formArea" width="400">
	<tr>
		<td class="formAreaTitle">{$translate_field_tax_rate_zone_id}</td>
		<td class="fieldValue"><input type="text" name="tax_rate_zone_id" value="{$tax_rate->get_tax_rate_zone_id()}" id="tax_rate_zone_id">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_tax_class_id}</td>
		<td class="fieldValue"><input type="text" name="tax_class_id" value="{$tax_rate->get_tax_class_id()}" id="tax_class_id">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_tax_rate_priority}</td>
		<td class="fieldValue"><input type="text" name="tax_rate_priority" value="{$tax_rate->get_tax_rate_priority()}" id="tax_rate_priority">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_tax_rate_value}</td>
		<td class="fieldValue"><input type="text" name="tax_rate_value" value="{$tax_rate->get_tax_rate_value()}" id="tax_rate_value">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_tax_rate_description}</td>
		<td class="fieldValue"><input type="text" name="tax_rate_description" value="{$tax_rate->get_tax_rate_description()}" id="tax_rate_description">
</td>
	</tr>
	<tr>
		<td colspan="6">
