...
<form method="post" action="index.php?page=product:add_product" id="add_product_frm" enctype="multipart/form-data" onsubmit="return validate_form(this);">
<input type="hidden" name="MAX_FILE_SIZE" value="300000000"> 
<ul class="subpanelTablist" id="groupTabs">
	<li id="All_sp_tab"><a class="current">Add Product</a></li>
</ul>
<table cellpadding="5" cellspacing="5" class="formArea" width="600">
	<tr>
		...
		<td class="fieldValue" colspan="2"><textarea name="product_description" rows="15" cols="70" {if $TINY_MCE_EDIT == true} mce_editable="true"{/if}>{$product_description}</textarea></td>
	</tr><tr>
