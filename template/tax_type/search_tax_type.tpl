...
<table width="100%" cellpadding="3" cellspacing="0" border="0" class="productListing">
	<tr>
		...
		<td class="productListing-heading">{$translate_field_tax_type_text}</td>
		<td class="productListing-heading">{$translate_field_tax_type_active}</td>
		<td class="productListing-heading">{$translate_text_view}</td>
	</tr>
	{foreach from=$tax_typeArray item=tax_type}
	<tr>
		<td class="productListing-data">{$tax_type->get_tax_type_id()}</td>
		<td class="productListing-data">{$tax_type->get_tax_type_text()}</td>
		<td class="productListing-data">{$tax_type->get_tax_type_active()}</td>
		<td class="productListing-data"><a href="index.php?page=tax_type:view_tax_type&tax_type_id={$tax_type->get_tax_type_id()}"><img src="images/icons/srch_16.gif" alt="View" border="0"></a></td>
	</tr>
	{foreachelse}
	<tr>
