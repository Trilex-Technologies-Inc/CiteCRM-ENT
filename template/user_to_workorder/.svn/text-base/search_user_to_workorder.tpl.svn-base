...
<table width="100%" cellpadding="3" cellspacing="0" border="0" class="productListing">
	...
	{foreach from=$user_to_workorderArray item=user_to_workorder}
	<tr>
		<td class="productListing-data">{$user_to_workorder->get_user_to_workorder_id()}</td>
		<td class="productListing-data">{$user_to_workorder->get_user_id()}</td>
		<td class="productListing-data">{$user_to_workorder->get_workorder_id()}</td>
		<td class="productListing-data"><a href="index.php?page=user_to_workorder:view_user_to_workorder&user_to_workorder_id={$user_to_workorder->get_user_to_workorder_id()}"><img src="images/icons/srch_16.gif" alt="View" border="0"></a></td>
	</tr>
	{foreachelse}
	<tr>
