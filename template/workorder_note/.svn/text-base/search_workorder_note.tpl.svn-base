...
<table width="100%" cellpadding="3" cellspacing="0" border="0" class="productListing">
	<tr>
		...
		<td class="productListing-heading">Note</td>
		<td class="productListing-heading">View</td>
	</tr>
	{foreach from=$workorder_noteArray item=workorder_note}
	<tr>
		<td class="productListing-data">{$workorder_note->get_workorder_note_id()}</td>
		<td class="productListing-data">{$workorder_note->get_workorder_id()}</td>
		<td class="productListing-data">{$workorder_note->get_workorder_note_create_by()}</td>
		<td class="productListing-data">{$workorder_note->get_workorder_note_text()}</td>
		<td class="productListing-data"><a href="index.php?page=workorder_note:view_workorder_note&workorder_note_id={$workorder_note->get_workorder_note_id()}"><img src="images/icons/srch_16.gif" alt="View" border="0"></a></td>
	</tr>
	{foreachelse}
	<tr>
