<!-- update_check_payment_frm -->
{include file="core/header.tpl"}

<table cellpadding="0" cellspacing="0" width="400">
	<tr>
		<td><span class="greetUser">Update Check Payment ID# {$check_payment->get_check_payment_id()}</span></td>
		<td align="right"></td>
</tr>
</table>
...
<form method="post" action="index.php?page=check_payment:update_check_payment" id="add_check_payment_frm">

<table cellpadding="5" cellspacing="5" class="formArea" width="400">
	<tr>
		<td class="formAreaTitle">{$translate_field_invoice_id}</td>
		<td class="fieldValue"><input type="text" name="invoice_id" value="{$check_payment->get_invoice_id()}" id="invoice_id">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_check_payment_amount}</td>
		<td class="fieldValue"><input type="text" name="check_payment_amount" value="{$check_payment->get_check_payment_amount()}" id="check_payment_amount">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_check_payment_number}</td>
		<td class="fieldValue"><input type="text" name="check_payment_number" value="{$check_payment->get_check_payment_number()}" id="check_payment_number">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_check_payment_enter_by}</td>
		<td class="fieldValue"><input type="text" name="check_payment_enter_by" value="{$check_payment->get_check_payment_enter_by()}" id="check_payment_enter_by">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_check_payment_date}</td>
		<td class="fieldValue"><input type="text" name="check_payment_date" value="{$check_payment->get_check_payment_date()}" id="check_payment_date">
</td>
	</tr>
	<tr>
		<td class="formAreaTitle">{$translate_field_check_payment_status}</td>
		<td class="fieldValue"><input type="text" name="check_payment_status" value="{$check_payment->get_check_payment_status()}" id="check_payment_status">
</td>
	</tr>
	<tr>
		<td colspan="7">
		<input type="hidden" name="check_payment_id" value="{$check_payment_id}">
