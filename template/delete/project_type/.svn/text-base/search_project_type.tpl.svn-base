...
<table width="100%" cellpadding="3" cellspacing="0" border="0" class="productListing">
	...
	{foreach from=$project_typeArray item=project_type}
	<tr>
		<td class="productListing-data">{$project_type->get_project_type_id()}</td>
		<td class="productListing-data">{$project_type->get_project_type_name()}</td>
		<td class="productListing-data"><a href="index.php?page=project_type:view_project_type&project_type_id={$project_type->get_project_type_id()}"><img src="images/icons/srch_16.gif" alt="View" border="0"></a></td>
	</tr>
	{foreachelse}
	<tr>
