...
<table width="100%" cellpadding="3" cellspacing="0" border="0" class="productListing">
	...
	{foreach from=$system_modelArray item=system_model}
	<tr>
		<td class="productListing-data">{$system_model->get_system_model_id()}</td>
		<td class="productListing-data">{$system_model->get_system_manufacture_id()}</td>
		<td class="productListing-data">{$system_model->get_system_model_name()}</td>
		<td class="productListing-data"><a href="index.php?page=system_model:view_system_model&system_model_id={$system_model->get_system_model_id()}"><img src="images/icons/srch_16.gif" alt="View" border="0"></a></td>
	</tr>
	{foreachelse}
	<tr>
