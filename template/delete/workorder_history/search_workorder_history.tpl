...
<table width="100%" cellpadding="3" cellspacing="0" border="0" class="productListing">
	<tr>
		...
		<td class="productListing-heading">Work Order ID</td>
		<td class="productListing-heading">History</td>
		<td class="productListing-heading">Created</td>
		<td class="productListing-heading">View</td>
	</tr>
	{foreach from=$workorder_historyArray item=workorder_history}
	<tr>
		<td class="productListing-data">{$workorder_history->get_workorder_history_id()}</td>
		<td class="productListing-data">{$workorder_history->get_workorder_id()}</td>
		<td class="productListing-data">{$workorder_history->get_workorder_history_text()}</td>
		<td class="productListing-data">{$workorder_history->get_workorder_history_create_date()}</td>
		<td class="productListing-data"><a href="index.php?page=workorder_history:view_workorder_history&workorder_history_id={$workorder_history->get_workorder_history_id()}"><img src="images/icons/srch_16.gif" alt="View" border="0"></a></td>
	</tr>
	{foreachelse}
	<tr>
