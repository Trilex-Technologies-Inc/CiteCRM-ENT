...
<table width="100%" cellpadding="3" cellspacing="0" border="0" class="productListing">
	...
	{foreach from=$company_to_workorderArray item=company_to_workorder}
	<tr>
		<td class="productListing-data">{$company_to_workorder->get_company_to_workorder_id()}</td>
		<td class="productListing-data">{$company_to_workorder->get_company_id()}</td>
		<td class="productListing-data">{$company_to_workorder->get_workorder_id()}</td>
		<td class="productListing-data"><a href="index.php?page=company_to_workorder:view_company_to_workorder&company_to_workorder_id={$company_to_workorder->get_company_to_workorder_id()}"><img src="images/icons/srch_16.gif" alt="View" border="0"></a></td>
	</tr>
	{foreachelse}
	<tr>
