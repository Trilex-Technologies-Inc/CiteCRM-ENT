...
<table width="100%" cellpadding="3" cellspacing="0" border="0" class="productListing">
	<tr>
		...
		<td class="productListing-heading">Street 2</td>
	...
	{foreach from=$company_addressArray item=company_address}
	<tr>
		<td class="productListing-data">{$company_address->get_company_address_id()}</td>
		<td class="productListing-data">{$company_address->get_company_id()}</td>
		<td class="productListing-data">{$company_address->get_company_street_1()}</td>
		<td class="productListing-data">{$company_address->get_company_street_2()}</td>
		<td class="productListing-data">{$company_address->get_company_city()}</td>
		<td class="productListing-data">{$company_address->get_company_state()}</td>
		<td class="productListing-data">{$company_address->get_company_postal_code()}</td>
		<td class="productListing-data">{$company_address->get_company_country()}</td>
		<td class="productListing-data"><a href="index.php?page=company_address:view_company_address&company_address_id={$company_address->get_company_address_id()}"><img src="images/icons/srch_16.gif" alt="View" border="0"></a></td>
	</tr>
	{foreachelse}
	<tr>
