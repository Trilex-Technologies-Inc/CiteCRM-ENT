...
<table width="100%" cellpadding="3" cellspacing="0" border="0" class="productListing">
	<tr>
		<td class="productListing-heading">{$translate_field_manufacture}</td>
		<td class="productListing-heading">{$translate_field_manufacture_name}</td>
		<td class="productListing-heading">{$translate_field_manufacture_image}</td>
		<td class="productListing-heading">{$translate_text_view}</td>
	</tr>
	{foreach from=$manufactureArray item=manufacture}
	<tr>
		<td class="productListing-data">{$manufacture->get_manufacture_id()}</td>
		<td class="productListing-data">{$manufacture->get_manufacture_name()}</td>
		<td class="productListing-data">{$manufacture->get_manufacture_image()}</td>
		<td class="productListing-data"><a href="{$ROOT_URL}/index.php?page=manufacture:view_manufacture&manufacture_id={$manufacture->get_manufacture_id()}"><img src="images/icons/srch_16.gif" alt="View" border="0"></a></td>
	</tr>
	{foreachelse}
	<tr>
