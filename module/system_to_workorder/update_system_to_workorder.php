...
* Type:     Cite CMS PHP Page<br>
	* Name:     update_system_to_workorder.php<br>
	* Purpose:  Update a Single System To Workorder row<br>
	* 
...
if(isset($_REQUEST['submit']) ) {
	...
	SmartyValidate::connect($smarty);
		...
		if(SmartyValidate::is_valid($_POST)) {
			...
			$system_to_workorder->update_system_to_workorder($_REQUEST);
			$core->force_page("index.php?page=system_to_workorder:view_system_to_workorder&system_to_workorder_id=".$_REQUEST['system_to_workorder_id']);
		} else {
			// error, redraw the form
			$smarty->assign($_POST);
			$smarty->display('system_to_workorder/update_system_to_workorder_frm.tpl');
		}
} else {
	// Display the Form
...
$system_to_workorder->view_system_to_workorder($_REQUEST['system_to_workorder_id']);
	...
	SmartyValidate::register_form('update_system_to_workorder_frm');
