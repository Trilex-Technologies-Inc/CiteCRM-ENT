...
$support_call_array = $supportCallObj->load_by_type($support_call_type,$support_call_type_id,$field,$sort,$start,$limit,&$total);
...
$smarty->display('support_call/ajax_load_support_calls.tpl');
