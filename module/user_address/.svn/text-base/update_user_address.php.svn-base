...
$address->loadByAddressType($_REQUEST['address_type'],$accountID,$_SESSION['SESSION_USER_ID']);
...
if(isset($_REQUEST['submit']) ) {
	...
	if(SmartyValidate::is_valid($_POST)) {
		...
		// error, redraw the form
           $smarty->assign($_POST);
           $smarty->display('user_address/update_user_address_frm.tpl');
	}
