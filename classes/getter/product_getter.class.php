...
* Name:    	productGetter<br>
* Purpose:  	For all Products fields<br>
...
*/
class product_getter {

	/**
	 	* Type:     Public Getter<br>
	 	* Name:     get_product_id<br>
	 	* Purpose:  Returns product_id Database field<br>
	 	*
 ...
 function get_product_sku() {
    ...
    function get_product_markup() {
        return $this->fields['product_markup'];
    }

    function get_product_sell_price() {
        $sellPrice = $this->fields['product_price'] + $this->fields['product_markup'];
